...
function trendFromPercent(pct) {
  const base = Number(pct) || 90;
  return ['P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8'].map((p, i) => ({
    period: p,
    percent: Math.max(80, Math.min(98, base + ((i % 3) - 1) * 2)),
  }));
}
...
export default function DashboardPage({
  ...
  const trendData = useMemo(
    () => trendFromPercent(stats.attendancePercent),
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          <h2 className="mb-4 text-base font-bold text-gray-900">Today&apos;s Attendance Trend</h2>
          <div className="h-52">
            <ResponsiveContainer width="100%" height="100%">
