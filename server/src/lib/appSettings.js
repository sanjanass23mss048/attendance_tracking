...
export const APP_SETTING_GROUPS = [
  {
    ...
    fields: [
      ...
      { key: 'SMS_MSG91_TEMPLATE_ID', label: 'MSG91 template ID' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'WHATSAPP_TEMPLATE_NAME', label: 'Approval template name' },
      { key: 'WHATSAPP_TEMPLATE_LANG', label: 'Template language', hint: 'e.g. en' },
      { key: 'WHATSAPP_ABSENCE_TEMPLATE', label: 'Absence template name', hint: 'Optional' },
      { key: 'WHATSAPP_ABSENCE_TEMPLATE_LANG', label: 'Absence template language' },
    ],
  },
  {
    id: 'push',
